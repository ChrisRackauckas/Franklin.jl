...
@testset "Literate-c" begin
    ...
    s = raw"""
        \literate{/foo}
        """
    @test @test_logs (:warn, r"File not found when trying to convert a literate file *") (s |> fd2html_td) == """<p><span style="color:red;">// Literate file matching '/foo' not found. //</span></p></p>\n"""
end
